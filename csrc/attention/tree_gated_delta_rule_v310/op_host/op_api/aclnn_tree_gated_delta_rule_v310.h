...
extern "C" {
#endif
__attribute__((visibility("default"))) aclnnStatus aclnnTreeGatedDeltaRuleV310GetWorkspaceSize(
...
__attribute__((visibility("default"))) aclnnStatus aclnnTreeGatedDeltaRuleV310(
