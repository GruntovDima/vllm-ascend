...
/*!
 * \file quant_batch_matmul_v3_int8_process.h
 * \brief INT8 kernel Process() implementation: Phase X / Phase D pipeline loop.
 * \author Feodor Pisnitchenko
 *
 * Included by quant_batch_matmul_v3_int8.h AFTER the class
 * declaration; do not include directly.
 */
#ifndef QUANT_BATCH_MATMUL_V3_INT8_PROCESS_H
#define QUANT_BATCH_MATMUL_V3_INT8_PROCESS_H
...
#endif  // QUANT_BATCH_MATMUL_V3_INT8_PROCESS_H
