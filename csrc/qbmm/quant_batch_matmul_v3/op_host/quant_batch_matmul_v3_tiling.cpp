...
/*!
 * \file quant_batch_matmul_v3_tiling.cpp
 * \brief Tile selection for QuantBatchMatmulV3: candidate enumeration + cost-model pick + pertoken/scale coalesce.
...
#include "../op_kernel/quant_batch_matmul_v3_config.h"
