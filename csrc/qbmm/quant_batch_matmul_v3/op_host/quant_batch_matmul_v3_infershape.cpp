 ...
 * \brief Inline shape inference for QuantBatchMatmulV3 (no common/ deps); handles ND and FRACTAL_NZ x2.
...
static const InferShapeFuncRegister  if_reg_qbm("QuantBatchMatmulV3",
    [](Operator &v) -> graphStatus { return InferShapeOld(v); });
static const InferFormatFuncRegister ff_reg_qbm("QuantBatchMatmulV3",
